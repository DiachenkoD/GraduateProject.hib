...
public class APIHandlerServlet extends HttpServlet{
  ...
  private static Map<String, APIRequestHandler> apiRequestHandlers = new HashMap<String, APIRequestHandler>();

    static {
        Map<String, APIRequestHandler> map = new HashMap<String, APIRequestHandler>();

        map.put("description", DescriptionServlet.getInstance());
